...
<script src="assets/js/sm/barchart2.js"> </script>
...
$(function() {
    ...
    d3.json("assets/data/US_State_data.json",function(jdat)
		...
		//var combo_options = _g.state_data[1]
...
function update_charts()
	...
	d3.selectAll('svg path')
		...
		{ 
		    ...
		    var pathid = d3.select(this).attr('id');
		     _g.path_original_colour = d3.selectAll('#bardiv rect.ggbar[key="'+pathid+'"]').style('fill');
		    d3.selectAll('#bardiv rect.ggbar[key="'+pathid+'"]').style('fill','red');
	...
	d3.selectAll('svg path')
		...
		var pathid = d3.select(this).attr('id');
		d3.selectAll('#bardiv rect.ggbar[key="'+pathid+'"]').style('fill',_g.path_original_colour);
	    })

	d3.selectAll('#bardiv rect.ggbar')
	    .on('mouseover',function()
		{ 
		    d3.select(this).style('opacity',0.5);
